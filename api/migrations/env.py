...
# NOTA (Next Sec): recordings/streaming (StreamSession) não foram copiados
# do vms/ — gravação contínua e viewer session fora de escopo (ver
# .genesis/architecture/reuse-plan.md). Ao implementar os models novos
# (contacts, face_profiles, roi_schedules, event_clips — ver
